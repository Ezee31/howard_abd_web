...
from .views import splash_screen, alumno_detalle
...
urlpatterns = [
    ...
    path("ia_dashboard/", views.ia_dashboard, name="ia_dashboard"),
    path("ia_dashboard/reporte", views.reporte_ia_pdf, name="reporte_ia_pdf"),
    ...
    # Rutas AJAX y Utilidades Financieras
    path('filtrar_alumnos/', views.filtrar_alumnos, name='filtrar_alumnos'),
    path('descargar_factura/<int:pago_id>/', views.descargar_factura, name='descargar_factura'),
